; Title: Script Manager Full v.2.3 (Designd for Multiple folders)
...
Menu, FileMenu, Add ;******* Add a separator line.
...
Menu, FileMenu, Add ;******* Add a separator line.
Menu, FileMenu, Add, &Hide Script Manager to tray, GuiHide
Menu, FileMenu, Add, &Exit, GuiClose

Menu, ToolsMenu, Add, &Kill All Running Scripts, ButtonNuke
Menu, ToolsMenu, Add ;******* Add a separator line.
...
Menu, MyContextMenu, Add  ;******* Add a separator line.
...
Menu, Tray, Add, Show Script Manager, GuiShow
Menu, Tray, Add, Hide Script Manager to tray, GuiHide
Menu, Tray, Default
Menu, Tray, Add
Menu, Tray, Standard
...
; **************************** BEGIN SCRIPT ****************************
	  ...
	  Run, Edit %SelectedFullPath%\%NewFileName%.ahk
   }
...
MsgBox, 262148, , Would you you like to edit the following script?`n`n%A_WorkingDir%\%FileName%
   IfMsgBox, No
	  return
*/
Run, Edit %SelectedFullPath%\%FileName%
return
...
;______________________ System Tray
GuiHide:
Gui, hide
return
